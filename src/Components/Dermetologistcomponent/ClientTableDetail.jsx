...
export default function ClientTableDetail({ detail, visible, setShowDetail }) {
    ...
    return (
        <section className="bg-white rounded-xl p-3 shadow-md md:w-[22%] w-full h-auto space-y-4 mb-4" style={{ display: visible ? 'block' : 'none' }}>
            ...
            <div className="flex gap-3 py-4">
                ...
                <div className="h-10 w-35 text-xs border rounded-full hover:bg-secondary-text hover:text-white cursor-pointer flex justify-center items-center">
                    {/* <Link to= "/ai-analyze">
                        View AI Skin Report
                    </Link> */}
