...
export default function HomeNav() {
    ...
    return (
        ...
        `}>
            ...
            {/* Mobile Header */}
            <div className="md:hidden flex justify-between items-center text-white px-4 py-4  pb-4 space-y-4  backdrop-blur-md border-t border-white/20">
                <img src={lumeaLogo} alt="Lumea Logo" className="cursor-pointer"></img>
                <button
            ...
            <div className={`md:hidden transition-all duration-300 ease-in-out  ${
                ...
                <div className="px-6 pb-4 space-y-4  backdrop-blur-md border-t border-white/20">
                    <div className="flex flex-col space-y-2 text-white">
                        ...
                        <Link 
                            to="/sign-up" 
                            className="bg-[#9D82B6] px-6 py-2 rounded-full font-medium text-darkest-heading hover:bg-primary-color transition-all duration-200 text-center mt-2"
