...
export default function AppointmentCard({ appointment }){
 ...
 if (!appointment) return null; 
    return(
        <div className=" flex justify-between py-2 rounded-md border border-white bg-[#F6EBFD] group hover:bg-gradient-to-r from-[#1A151D]  to-[#755F83] transition-colors duration-300 cursor-pointer p-1 gap-2">
