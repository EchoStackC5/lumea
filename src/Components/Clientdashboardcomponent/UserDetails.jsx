    ...
    return (
        <section className="bg-white rounded-xl p-3 shadow-md w-[296px] h-[239.2px] space-y-4 mb-4">
            <div className="flex justify-between">
                <h1 className="md:text-lg text-md font-inter text-[#1A151D]">Details</h1>
                <button className="md:h-[30px] md:w-[96px] rounded-full bg-[#1A151D] text-white flex justify-center items-center text-sm">Analyze Skin</button>
            </div>
            {/* Client name & Pic */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-2 gap-1">
                <div className=" flex md:h-[50px] w-[100%] h-[30px] md:rounded-md rounded-md border border-white bg-[#F6EBFD] p-2 gap-3">
                    ...
                    <div className=" flex flex-col text-xs items-center">
                        ...
                        <h2 className="font-inter text-[#1A151D]">43</h2>
                    </div>
                </div>
                <div className=" flex md:h-[50px] w-[100%] h-[30px] md:rounded-md rounded-md border border-white bg-[#F6EBFD] p-2 gap-3">
                    <div className="h-7 w-7 rounded-full bg-[#9D105B26] flex justify-center items-center">
                    ...
                    <div className=" flex flex-col text-xs items-center">
                        ...
                        <h2 className="font-inter text-[#1A151D]">85 Kg</h2>
                    </div>
                </div>
                <div className=" flex md:h-[50px] w-[100%] h-[30px] md:rounded-md rounded-md border border-white bg-[#F6EBFD] p-2 gap-3">
                    ...
                    <div className=" flex flex-col text-xs items-center">
                        ...
                        <h2 className="font-inter text-[#1A151D]">182 cm</h2>
                    </div>
                </div>
                <div className=" flex md:h-[50px] w-[100%] h-[30px] md:rounded-md rounded-md border border-white bg-[#F6EBFD] p-2 gap-3">
                    ...
                    <div className="text-xs">
                        ...
                        <h2 className="font-inter text-[#1A151D]">Oily</h2>
                    </div>
                </div>
            </div>
